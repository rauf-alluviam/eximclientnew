...
const CustomerDetailView = ({
  ...
  const handleSaveModules = async () => {
    try {
      ...
      // Refresh the user data in cookies if this is the current user
      ...
      if (currentUser) {
        ...
        if (currentUserId === customer._id) {
          console.log(
            "🔄 Module assignment changed for current user, refreshing..."
          );
      ...
      const errorMessage =
        ...
        error.message ||
        "Failed to update module assignments";
  ...
  return (
    ...
    >
      ...
      <DialogContent sx={{ p: 0 }}>
        {/* Modern Tabs */}
        <Box
          sx={{ borderBottom: "1px solid #F3F4F6", backgroundColor: "#FFFFFF" }}
        >
          <Tabs
            value={activeTab}
                        ...
                        >
                          ...
                          <Tooltip title="Copy IE Code">
                            <IconButton
                              size="small"
                              onClick={() =>
                                handleCopy(customer.ie_code_no, "IE Code")
                              }
                            >
                        ...
                        >
                          ...
                          <Tooltip title="Copy PAN Number">
                            <IconButton
                              size="small"
                              onClick={() =>
                                handleCopy(customer.pan_number, "PAN Number")
                              }
                            >
                              <ContentCopy fontSize="small" />
                            </IconButton>
                    ...
                    >
                      ...
                      <Box>
                        ...
                        <Chip
                          ...
                          color={
                            customer.password_changed ? "warning" : "primary"
                          }
                          variant="outlined"
                          size="small"
                        />
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} md={6}>
                    <Alert severity="warning" sx={{ mb: 2 }}>
                      <Typography variant="body2">
                        <strong>Username:</strong> {customer.ie_code_no}
                        <br />
                  ...
                  <Box sx={{ mt: 3 }}>
                    ...
                    <Box sx={{ display: "flex", gap: 1 }}>
                      <Button
                        ...
                        disabled={
                          !newPassword || newPassword.length < 6 || loading
                        }
                      >
